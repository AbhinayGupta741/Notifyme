...
public class MainActivity extends AppCompatActivity {
    ...
    private Button select_categories;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myFirebaseRef = new Firebase("https://notifyme-1b154.firebaseio.com/users/");
        mAuth = FirebaseAuth.getInstance();




    select_categories = (Button)findViewById(R.id.id_select_categories);

        select_categories.setOnClickListener(new View.OnClickListener() {
            @Override
